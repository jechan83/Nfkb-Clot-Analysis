...
**_JC2434_** - Contains the Jupyter notebook to process FACS sorted LUAD tumors 18-19 weeks post tumor induction derived from _KP Rosa26<sup>RIK/+</sup>_ mice. Tumors were initiated with lentivirus containing either shRenilla or shNfkb1 hairpins. Mice were treated with Doxycycline for 1 week prior to harvest to induce hairpin expression.
